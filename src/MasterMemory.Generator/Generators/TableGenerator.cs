...
internal static class TableGenerator
{
    ...
    public static void Execute(in SourceProductionContext context, TableModel model)
    {
        var sb = new StringBuilder();
        {
            ...
            context.AddSource($"Tables/Interfaces/I{model.TableName}.g.cs",
        ...
        sb.ReplaceKeys(model);
        context.AddSource($"Tables/{model.TableName}.g.cs",
            SourceText.From(SourceTextFormatter.FormatCompilationUnit(sb.ToString()).ToFullString(), Encoding.UTF8));
    }
