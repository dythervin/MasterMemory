...
internal readonly struct TableModel
{
        ...
        ImmutableArray<KeyGroupModel> uniqueKeys, string tableName, DbTableFlags flags, int threadBatchSize)
    {
        ...
        TableFullName = "global::" + (string.IsNullOrEmpty(Namespace) ? TableName : Namespace + "." + TableName);
    ...
    public bool Equals(TableModel other)
    {
        return GlobalTypeName == other.GlobalTypeName && Keys.SequenceEqual(other.Keys) &&
               UniqueKeys.SequenceEqual(other.UniqueKeys) && TableName == other.TableName &&
               TableFullName == other.TableFullName && TableRawName == other.TableRawName && Flags == other.Flags &&
               ThreadBatchSize == other.ThreadBatchSize && ThreadCount == other.ThreadCount &&
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            ...
            hashCode = (hashCode * 397) ^ TableFullName.GetHashCode();
